...
public
    ...
    public AddForemanDialog(JFrame addForemanFrame, CentralPanel cp) {
        super(addForemanFrame, "Dodaj brygadzistę", true);
        setSize(400, 300);
        setLayout( new GridLayout(7, 2, 10, 10));
        setLocationRelativeTo(addForemanFrame);
        ...
        addButton.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Brygadzista dodany.");
                dispose();
